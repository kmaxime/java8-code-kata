...
public class Exercise4Test {
    ...
    public void zonedDateTimeParse() {
         ...
         */
        ZonedDateTime zonedDateTime = ZonedDateTime.parse("2015-06-18T23:07:25+09:00[Asia/Tokyo]", DateTimeFormatter.ISO_ZONED_DATE_TIME);
    ...
    public void zonedDateTimeFormat() {
         ...
         */
        String strZdt = zdt.format(DateTimeFormatter.ofPattern("uuuu_MM_dd_HH_mm_ss_z"));
